Minimal `grep` clone, based on the following specifications ([source](https://github.com/remzi-arpacidusseau/ostep-projects/tree/master/initial-utilities#myfootnote1), again modified `wgrep` to `rggrep`):
